...
<center>
::: text
I then sampled the same from the episodes we know are Helena. After filtering to only lines of dialogue that were at least 100 characters, we ended up with 5 such samples.
:::
